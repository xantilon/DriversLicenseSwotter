...
if (GM_getValue("Aktiv" + KlonNr, false) || (window.location.pathname == "/characters/index")) {
	...
	{	
    var regm = document.getElementById("button-annehmen").src.match(/annehmen\.jpg/);
    if (regm)
